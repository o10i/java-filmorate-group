...
(
    ...
    film_id     BIGINT  NOT NULL,
    user_id     BIGINT  NOT NULL,
    CONSTRAINT IF NOT EXISTS "film_id_reference"
        FOREIGN KEY (film_id)
            REFERENCES movie (id) ON DELETE CASCADE,
    CONSTRAINT IF NOT EXISTS "user_id_references"
        FOREIGN KEY (user_id)
            REFERENCES users (id) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT IF NOT EXISTS "review_id_reference"
        FOREIGN KEY (review_id)
            REFERENCES reviews (id) ON DELETE CASCADE,
    CONSTRAINT IF NOT EXISTS "user_id_reference"
        FOREIGN KEY (user_id)
            REFERENCES users (id) ON DELETE CASCADE,
